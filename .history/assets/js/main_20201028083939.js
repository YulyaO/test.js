 ...
 */
userObj=new Object();
userObj.firstName="Юля";
userObj.lastName="Олешко";
userObj.age=27;
...
let washNextItem = function (itemsLesh) {
    itemsLesh--;
    console.log('осталось посуды' + itemsLesh + 'предматев');
    if (itemsLesh > 0) {
        washNextItem(itemsLesh);
    }
};
washNextItem(10);


let MyError = new Error ('age must be in 62...122 range')
let age = 70;
let calculate = function (age) {
    if ( age < 65 && age > 122) throw MyError;
return age;
};
console.log( );
