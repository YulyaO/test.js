...
let myPow = адуе ьнЗщц = f (фб иб ьнЗкште)ю Dyenhb htfkbpeqnt htrehcb. lkz gjlcxtnf htpekmnfnf djpdtltybz xbckf ф d cntgtym ию
(a, b, myPrint). Внутри реализуйте рекурсию для подсчета результата возведения числа a в степень b.
